                                    ...
                                    <form id="form" action="{{ route('register.pacient.istoric') }}">
                                        <div class="row">
                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12"><input name="code"
                                                    placeholder="COD inregistrare" required class="input-register"
                                                    type="text">
                                            </div>
                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12"><input
                                                    placeholder="Nume" required class="input-register" type="text">
                                            </div>

                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12"><input
                                                    placeholder="Prenume" required class="input-register"
                                                    type="text">
                                            </div>
                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12"><input
                                                    placeholder="E-mail" required class="input-register" type="email">
                                            </div>
                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12"><input
                                                    placeholder="Parola" required class="input-register"
                                                    type="password">
                                            </div>
                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12"><input
                                                    placeholder="Data Nasterii" required class="input-register"
                                                    type="date">
                                            </div>
                                            ...
                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                                <button value="submit" class="submit-login btn btn-success btn-sm">Mergi
                                                    la pasul
                                                    urmator
                                                </button>
                                            </div>
